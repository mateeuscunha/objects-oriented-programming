...
public class Figura
{
    ...
    public void desenhar()
    {
        if(!desenhado) {
            ...
            sun.mudarCor("amarela");
            sun.moverHorizontal(-200);
            sun.moverVertical(-40);
            sun.mudarTamanho(80);
            sun.exibir();
            
            jose.moverHorizontal(-200);
            jose.moverVertical(25);
            jose.exibir();
    ...
    {
        sun.moverVerticalLento(400);
        sol.moverVerticalLento(400);
        
        jose.moverHorizontalLento(110);
        jose.esconder();
    }
}
