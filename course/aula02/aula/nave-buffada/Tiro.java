...
public class Tiro
{
    ...
    public Tiro(int x, int y, boolean tiroDoInimigo)
    {
        ...
        // objeto fica pronto para gerar números aleatórios
        random = new Random();
        
        // inicializa velocidade padrao
        velocidade = 20;      
        
        // se o tiro for do inimigo, quero que ele possa ser até 5 vezes
        // mais rápido. Como o random gera valores de 0 até o parâmetro
        // passado (no caso seria de 0 a 4), eu somei um pra ficar de 0 a 5.
        if (ehDoInimigo)
        {
            velocidade = (random.nextInt(5) + 1) * velocidade;
        }
    }
