...
public class Cenario
{
    ...
    {                      
        ...
        janela.setTitle("Aula Pratica IPOO: Jogo da Nave");
    ...
    {                    
        ...
        private void desenharMensagensGerais(Graphics g)
        {
            ...
            g.setColor(Color.GRAY);
            g.drawString("GAC125 (IPOO) - DAC/ICET/UFLA", (int)getSize().getWidth()-200, (int)getSize().getHeight()-15);
        }
        ...
        private void desenharPlacar(Graphics g)
        {
            ...
            g.drawString("Nivel Atual: " + placar.getNivelAtual(),
            posX, posY+20);
